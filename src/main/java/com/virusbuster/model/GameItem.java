...
class GameItem {
    ...
    private static ZippoLighter zippolighter;
    private static BubbleGum bubblegum;
    private static JackDaniels jackdaniels;
    private static IceContainer icecontainer;
    private static RainCoat raincoat;
    private static GoldRolexWatch goldrolexwatch;
    ...
    public static ItemInformation getItemInformation(String item){
        if(item == null){
            return null;
        }
        switch(item){
